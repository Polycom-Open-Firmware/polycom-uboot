...
ANATOP/CCM register writes the C60 fork appended. `lpddr4_timing.c` is a forked
copy of the C60 table; `lpddr4_timing.h` is a symlink to the C60 header
(shared). If TC8 needs anything board-specific later, fork the header too as
needed.
